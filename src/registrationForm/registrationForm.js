...
class RegistrationForm extends Component {
    ...
    render () {
        ...
        <form className="registration" onSubmit={e => this.handleSubmit(e)}>
            ...
            <ValidationError hasError={!this.state.nameValid} message={this.state.validationMessages.password}/>
            ...
            <ValidationError hasError={!this.state.nameValid} message={this.state.validationMessages.repeatPassword}/>
            </div>
